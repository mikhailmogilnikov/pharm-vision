...
export const CustomerNavigation = ({ promotionId }: Props) => {
  ...
  return pathname.split('/').length <= 4 ? (
    <Flex
      center
      className='fixed bottom-6 left-1/2 !-translate-x-[50%] !w-56 h-14 z-40 bg-default/50 backdrop-blur-lg rounded-2xl border-1 border-white/10 shadow-base animate-bounceUp'
      gap={14}
      tag='nav'
    >
